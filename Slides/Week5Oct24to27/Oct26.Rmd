...
- Measurement error is proportional to the inverse of the square root of the sample size.

- Standard error of the mean is $\hat{\sigma} / \sqrt{n}$
...
- "Margin of error" in polling: the margin of error is the radius of the confidence interval
    - So if they say "person X is leading by 2 with a margin of error of 4", are they really leading?
