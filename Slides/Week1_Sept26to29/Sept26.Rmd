...
We will be using the statistical programming language R (https://cran.r-project.org/)  in this class.
...
I highly suggest using this for homework.
...
My current specialty is the analysis of large data sets in biological experiments.  
