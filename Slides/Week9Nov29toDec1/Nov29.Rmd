...
- Method 1: Remove variables that are not important.
...
- Add weight, now regressions estimates look like
...
- Add weight and year, now regressions estimates look like
...
- Add weight, year, and origin, now regressions estimates look like
