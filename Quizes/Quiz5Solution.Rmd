...
$$\text{s.e.m.} = 1.9/\sqrt{50}$$    
    
b. Construct a $95 \%$ confidence interval for the mean recovery time of the new treatment.
    
$$\bar{x} \pm z_{\alpha/2} s / \sqrt{n} = 2.8 \pm 1.96 \cdot 1.9 / \sqrt{50} = (2.27, 3.33)$$
    
c. Approximately what sample size would you need to obtain a margin of error of $0.5$?
    
The margin of error is the radius of the confidence interval, equal to $1.96 \cdot 1.9 / \sqrt{n}$.  Therefore $n = (1.96 \cdot 1.9 / 0.5)^2 = 55.47 = 56$.  Remember we have to round up.
